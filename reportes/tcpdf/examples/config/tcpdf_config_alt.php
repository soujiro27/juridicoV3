 ...
 */
define ('PDF_HEADER_LOGO', 'logo-top.png');
 ...
 * Document creator.
 */
define ('PDF_CREATOR', 'AUDITORÌA');

/**
 * Document author.
 */
define ('PDF_AUTHOR', 'AUDITORÌA');

/**
 * Header title.
 */
define ('PDF_HEADER_TITLE', 'PROGRAMA GENERAL DE AUDITORÌA DE LA CUENTA PÙBLICA DE ');

/**
 * Header description string.
 */
define ('PDF_HEADER_STRING', "PROGRAMA ESPECÌFICO DE AUDITORIA");
